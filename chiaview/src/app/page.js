...
export default function Home() {
  return (
    <>
      ...
      {/* Core Values Section */}
      <section className="py-20 px-6 bg-white" aria-label="Our core values">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300"
              >
      ...
      {/* What We Do Section */}
      <section className="py-20 px-6 bg-gradient-to-b from-gray-50 to-white" aria-label="What we do">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {whatWeDo.map((item, index) => (
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-blue-800 hover:shadow-2xl transition duration-300"
              >
      ...
      <section id="contact" className="py-20 px-6 bg-white" aria-label="Contact form">
